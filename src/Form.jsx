                ...
                <div >
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <textarea name="todo" className="create-todo-text" value={this.state.todo} onChange={this.handleInputChange} />
                        ...
                        <div className="card-footer">
                            <button id='add-item' onClick={() => this.props.handleFormSubmit(this.state.todo, this.state.priority)}>Add</button>
                        </div>
                    </div>
                </div>
            </div>
